...
uci set wireless.@wifi-iface[0].ssid='M28C'
uci set wireless.@wifi-iface[0].key='1776722060'
uci set wireless.@wifi-iface[0].encryption='psk2'

# 3. 配置 2.4G Wi-Fi
uci set wireless.@wifi-iface[1].ssid='M28C-2.4G'
uci set wireless.@wifi-iface[1].key='1776722060'
